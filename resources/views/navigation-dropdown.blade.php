    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('subcontractors.index') }}"
                        :active="request()->routeIs('subcontractors.*')">
                        Subcontractor
                    </x-jet-nav-link>
                </div>
                @endcan
                @can('wtgtype_access')
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('wtgtype.index') }}" :active="request()->routeIs('wtgtype.*')">
                        WTG Type
                    </x-jet-nav-link>
                </div>
                @endcan
